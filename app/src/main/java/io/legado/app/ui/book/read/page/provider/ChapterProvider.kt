...
object ChapterProvider {
    ...
    @JvmStatic
    var titleRubyPaint: TextPaint = TextPaint()

    @JvmStatic
    var contentRubyPaint: TextPaint = TextPaint()

    @JvmStatic
    var titleRubyPaintTextHeight = 0f
        private set

    @JvmStatic
    var contentRubyPaintTextHeight = 0f
        private set
...
//            reviewPaint.textAlign = Paint.Align.CENTER
        ...
        titleRubyPaint = createRubyPaint(titlePaint)
        contentRubyPaint = createRubyPaint(contentPaint)
        //间距
        ...
        titleRubyPaintTextHeight = titleRubyPaint.textHeight
        contentRubyPaintTextHeight = contentRubyPaint.textHeight
    ...
    private fun createRubyPaint(basePaint: TextPaint): TextPaint {
        return TextPaint(basePaint).apply {
            textSize = basePaint.textSize * 0.45f
    ...
    fun getRubyPadding(isTitle: Boolean): Float {
        return if (isTitle) titleRubyPaintTextHeight else contentRubyPaintTextHeight
    }
